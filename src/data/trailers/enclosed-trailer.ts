...
export const enclosedTrailer: TrailerSpec = {
  ...
  description: "Professional-grade enclosed trailer perfect for secure transport of furniture, equipment, and sensitive items." break "Buy outright for $7,750 firm",
  features: [
